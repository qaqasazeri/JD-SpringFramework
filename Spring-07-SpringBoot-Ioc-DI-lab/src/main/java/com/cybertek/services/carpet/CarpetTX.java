...
public class CarpetTX implements Carpet {
    ...
    static{
        sqPriceForCity.put(City.DALLAS,new BigDecimal("4.32"));
        sqPriceForCity.put(City.SAN_ANTONIO,new BigDecimal("2.92"));
        sqPriceForCity.put(City.AUSTIN,new BigDecimal("3.12"));
